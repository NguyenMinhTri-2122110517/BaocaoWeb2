...
ProductDTO updateAdditionalImages(Long productId, MultipartFile image1, MultipartFile image2, MultipartFile image3) throws IOException;
public InputStream getProductImage(String fileName) throws FileNotFoundException;
ProductResponse searchProductByKeyword (String keyword, Long categoryId, Integer pageNumber, Integer pageSize, String
sortBy,
String sortOrder);
